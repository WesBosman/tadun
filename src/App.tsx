...
function App() {
  return (
    <div className="flex flex-col gap-4 w-3/5 p-4 m-auto bg-slate-800">
      ...
      <div className="w-full">
          <div className="flex justify-between align-center text-slate-700 w-100 pt-2 gap-2">
              ...
              <div className={"hover:cursor-pointer hover:text-blue-700 text-blue-400"} onClick={rootStore.today}>Today</div>
